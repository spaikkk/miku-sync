...
int main(){
   ...
   // Create application window
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Spike's MikuSync", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    bool ret = LoadTextureFromFile("damiano.jpg", &my_texture, &my_image_width, &my_image_height);
